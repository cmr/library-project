...
\addtitle{Use Case 3}{Database \textit{(Alex Macri)}}
...
\addscenario{Extensions:}{
	\item[1.a] Invalid login data:
		...
		\item[2.] User cannot login and prompts the user to retry
		\end{enumerate}
	\item[1.b] Valid login data:
		\begin{enumerate}
		\item[1.] System shows success message
		\item[2.] User continues onto the site
		\end{enumerate}
	\item[2.a] Invalid checkout data:
		\begin{enumerate}
		\item[1.] System shows failure message
		\end{enumerate}
	\item[2.b] Valid checkout data:
		\begin{enumerate}
		\item[1.] System shows success message
		\item[2.] User has checkouted out the book and the database is modified
		\end{enumerate}
	\item[3.a] Invalid checkin data:
		\begin{enumerate}
		\item[1.] System shows failure message
		\end{enumerate}
	\item[3.b] Valid checkin data:
		\begin{enumerate}
		\item[1.] System shows success message
...
%Technology and Data Variations List: Varying I/O methods and data formats.
\addscenario{Technology and Data Variations List:}{
	\item[1a.] Implemented with Rust Programming Language
	\item[1b.] Uses post-gres database server
	\item[1c.] Runs on standard linux systems
}
