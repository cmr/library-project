...
\addtitle{Use Case 4}{Vieweing Meeting Videos \textit{(Adam Kimball)}}
...
\addscenario{Main Success Scenario:}{
    ...
    \item User is presented with an embedded video player, as well as a small summary of what happened at hte metting
}
...
\addtitle{Use Case 5}{Database \textit{(Alex Macri)}}
...
\addfield{Scope:}{Library Management System}
\addfield{Level:}{User-goal}
\addfield{Primary Actor:}{Database}
\additemizedfield{Stakeholders and Interests:}{
